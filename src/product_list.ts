const featured: Product[] = [
    ...
    { id: 9, name: "kit hidratação, renovação e antienvelhecimento", description: "Géis para uma rotina de cuidados." },
    {
        id: 10,
    ...
    { id: 11, name: "tônico adstringente", description: "tônico facial que remove as impurezas da pele, deixa a pele luminosa, com viço e hidrata." },
    {
        id: 12,
...
const kits = [
    ...
    { id: 14, name: "kit hidratação, renovação e antienvelhecimento", description: "Géis para uma rotina de cuidados essenciais." },
    {
        id: 15,
        name: "kit tudinho",
        description:
...
const cleaners = [
    ...
    { id: 17, name: "gel de limpeza clareador", description: "Gel clareador que uniformiza a pele, removendo manchas causadas pelas acnes." },
    {
        id: 18,
        name: "gel de limpeza antiacne",
...
const oiled_skin = [
    ...
    { id: 20, name: "tônico adstringente", description: "tônico facial que remove as impurezas da pele, deixa a pele luminosa, com viço e hidrata." },
    {
        id: 21,
        name: "sérum retinol",
        description:
    ...
    { id: 23, name: "creme facial", description: "Creme com toque seco que hidrata a pele por 48h, sem deixar oleosa." },
]
